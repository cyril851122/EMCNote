    ...
    public static class HtmlToXamlConverter
    {
        ...
        private static void AddTable(XmlElement xamlParentElement, XmlElement htmlTableElement, Hashtable inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            else
            {
                ...
                //Bugfix for Table.Columns
                XmlElement xamlTableColumnElement=xamlParentElement.OwnerDocument.CreateElement(null,"Table.Columns",_xamlNamespace);
                ...
                AddColumnInformation(htmlTableElement, xamlTableColumnElement, columnStarts, currentProperties, stylesheet, sourceContext);
